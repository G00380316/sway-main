...
zsh ~/ArchDispManConf/install_scripts/setup.sh

clear

# Run the extra packages
zsh ~/ArchDispManConf/install_scripts/packages.sh
...
zsh ~/ArchDispManConf/install_scripts/gdm.sh

clear

# add bashrc question
zsh ~/ArchDispManConf/install_scripts/add_bashrc.sh

clear

zsh ~/ArchDispManConf/install_scripts/printers.sh

clear

zsh ~/ArchDispManConf/install_scripts/bluetooth.sh
